...
// InfixExpression represents an infix expression such as <expression> <operator> <expression> in the AST.
//   - Token: the infix token
//   - Left: the expression to the left of the operator
//   - Operator: the operator of the infix expression, e.g. + or -
//   - Right: the expression to the right of the operator
